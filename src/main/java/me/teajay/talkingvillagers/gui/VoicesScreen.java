...
public class VoicesScreen extends SpruceScreen {
    ...
    public VoicesScreen(@Nullable Screen parent) {
        super(Text.translatable("talkingvillagers.voicescreen.title"));
        this.parent = parent;
    }
    ...
    private void drawNoVoicePacksInstalledMessage() {
        this.addDrawableChild(new SpruceLabelWidget(Position.of(this.width/2-100, 40), Text.translatable("talkingvillagers.voicescreen.text.no_voices_installed"), 200));
    }

    private SpruceLabelWidget drawLoadingText() {
        var loadingText = new SpruceLabelWidget(Position.of(this.width/2-100, 40), Text.translatable("talkingvillagers.voicescreen.text.no_voices_installed"), 200);
        this.addDrawableChild(loadingText);
        return loadingText;
    }

    private void drawOpenVoicepacksFolderButton() {
        this.addDrawableChild(new SpruceButtonWidget(Position.of(this, this.width / 2 - 75, this.height - 29), 150, 20, Text.translatable("talkingvillager.voicescreen.button.voicepackfolder"),
    ...
    private void drawDoneButton() {
        this.addDrawableChild(new SpruceButtonWidget(Position.of(this, this.width / 2 + 76, this.height - 29), 125, 20, Text.translatable("talkingvillager.voicescreen.button.done"),
                btn -> this.client.setScreen(this.parent)));
    }

    private void drawSettingsButton() {
        var settingsScreen = new ModMenuSettingsScreen().getModConfigScreenFactory().create(this);
        this.addDrawableChild(new SpruceButtonWidget(Position.of(this, this.width / 2 - 200, this.height - 29), 125, 20, Text.translatable("talkingvillager.voicescreen.button.settings"),
